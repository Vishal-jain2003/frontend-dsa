...
//       <h2 className="text-2xl font-semibold tracking-tight mb-6 text-primary">Quiz Results</h2>
//       <p className="mb-6 text-xl text-foreground">
//         Your Score: <span className="font-bold">{calculateScore()}</span> out of {mcqs.length}
//       </p>
//       <ul className="space-y-6">
//         {mcqs.map((mcq, index) => (
//           <li key={index} className="border-b border-border pb-4">
//             <p className="text-muted-foreground mb-2">{mcq.question}</p>
//             <p>Your Answer: <span className="font-medium text-foreground">{selectedAnswers[index] || 'None'}</span></p>
//             <p>Correct Answer: <span className="font-medium text-primary">{mcq.correctAnswer}</span></p>
//             <p
//               className={
...
//               }
//             >
//               Status: {selectedAnswers[index] === mcq.correctAnswer ? 'Correct' : 'Incorrect'}
//             </p>
//           </li>
//         ))}
//       </ul>
//       <button
//         onClick={onReset}
//         className="mt-6 w-full btn-glow text-white py-2 rounded-lg hover:bg-accent"
//       >
//         Start New Quiz
//       </button>
//     </div>
...
//       className="max-w-lg mx-auto p-6 bg-gray-900 border border-gray-800 rounded-lg shadow-lg glassmorphism"
//     >
//       <h2 className="text-2xl font-semibold text-primary mb-6">Quiz Results</h2>
//       <p className="mb-6 text-xl text-gray-200">
//         Your Score: <span className="font-bold text-green-500">{calculateScore()}</span> out of {mcqs.length}
//       </p>
//       <ul className="space-y-6">
//         {mcqs.map((mcq, index) => (
//           <motion.li
...
//           >
//             <p className="text-gray-400 mb-2">{mcq.question}</p>
//             <p>Your Answer: <span className="font-medium text-gray-200">{selectedAnswers[index] || 'None'}</span></p>
//             <p>Correct Answer: <span className="font-medium text-green-500">{mcq.correctAnswer}</span></p>
//             <p
//               className={
//                 selectedAnswers[index] === mcq.correctAnswer
//                   ? 'text-green-500 font-medium'
...
//         whileTap={{ scale: 0.95 }}
//         onClick={onReset}
//         className="mt-6 w-full px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all"
//       >
//         Start New Quiz
//       </motion.button>
//     </motion.div>
