...
const HomePage = () => {
  ...
  description: 'Master CS, DSA, and AI with curated quizzes by Vishal Jain. Boost your prep with instant feedback and timed challenges.',
  icon: Brain, 
  ...
  const testimonials = [
    ...
    },
    {
      ...
      feedback: "This platform has been a game-changer for my interview preparation. The Quizzes keeps me consistent, and the AI recommendations help me focus on similar problems.",
    },
    {
      "name":"Amit Jain",
      "role":"Software Engineer",
      "image":"https://res.cloudinary.com/dsbbhvnoi/image/upload/v1746706629/nyptovhtqh3ppri9hfd9.jpg",
      "feedback":"The UI is Attractive and easy to navigate. I love how I can track my progress and see my strengths and weaknesses clearly.",
    },
    
    {
      ...
      feedback: "The quizzes are amazing. It motivates me to practice daily, and the problem recommendations are spot on for my skill level.",
    },
     {
  "name": "Vicky Singh",
  "role": "Full Stack Developer",
  "image": "https://res.cloudinary.com/dsbbhvnoi/image/upload/v1746554190/wxypgzpxy5trmxuuro7x.jpg",
  "feedback": "The AI-powered quizzes are a fantastic addition. They help me identify my weak areas and improve my problem-solving skills effectively."
},
{
  "name": "Umang Bishya",
  "role": "Full Stack Developer",
  ...
  "feedback": "I’ve improved my coding skills dramatically using this platform. The UI is clean, and the challenges are well-structured."
    ...
    "feedback": "The AI recommendations are incredibly helpful. They suggest problems that are relevant to my current skill level, making practice more effective.",
  },
  {
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-block rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-5">
              The Ultimate DSA And CS Fundamentals Companion
            </div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 [text-wrap:balance]">
              Master Data Structures & Algorithms with Structured Practice And AI Powered Quizzes
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-10 [text-wrap:balance]">
              Enhance your DSA prep with intelligent quizzes and personalized AI recommendations.
            </p>
...
{" "}
  ...
  // src="/vishaljainbestphoto.jpg"
  src="/newvj.png"

  
  alt="Developer Name"
  // className="w-40 h-70 rounded-full border-4 border-primary shadow-lg object-cover object-top"
...
/>
    ...
    <div className="flex justify-center mb-6">
  <div className="w-64 h-64 rounded-full border-4 border-red-500 shadow-lg overflow-hidden">
    <img
      src="/newvj.png"
      alt="Vishal Jain"
